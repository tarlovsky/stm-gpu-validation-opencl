...
set multiplot layout 1,3 rowsfirst title "genome - Validation success rate" font ",16"
set bmargin 3
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/1-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/1a-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/2-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/4-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/8-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/16-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/32-genome-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
