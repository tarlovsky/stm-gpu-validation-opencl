...
plot \
 ...
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-8-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "CPU 02 8 THREADS VALIDATING random array traversal" lc rgb "black" pt 7,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-4-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "CPU 02 4 THREADS VALIDATING random array traversal" dt new1 lc rgb "black" pt 7,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-2-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "CPU 02 2 THREADS VALIDATING random array traversal" dt new lc rgb "black" pt 7,\
...
plot \
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-8-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "random walk CPU 02   8 THREADS VALIDATING" lc rgb "black" pt 1,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-4-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "random walk CPU 02   4 THREADS VALIDATING" dt new1 lc rgb "black" pt 1,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-random-walk/1a-random-cpu-validation-2-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "random walk CPU 02   2 THREADS VALIDATING" dt new lc rgb "black" pt 1,\
 ...
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-sequential-walk/1a-sequential-cpu-validation-8-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "sequential walk CPU O2   8 THREADS VALIDATING" lc rgb col_gold pt 1,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-sequential-walk/1a-sequential-cpu-validation-4-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "sequential walk CPU O2   4 THREADS VALIDATING" dt new1 lc rgb col_gold pt 1,\
 'results-validation-array/TinySTM-threads-wbetl/1a/array-r99-w1-sequential-walk/1a-sequential-cpu-validation-2-workers' u ($0 + 3):2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t "sequential walk CPU 02   2 THREADS VALIDATING" dt new lc rgb col_gold pt 1,\
