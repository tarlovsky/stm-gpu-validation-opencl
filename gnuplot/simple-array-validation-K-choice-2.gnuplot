...
set multiplot layout 2,1 title "Optimizing number of elements/work-item. SEQUENTIAL array walk - Intel HD530" font "Computer Modern,16"
...
set ylabel offset 2.5,0 "K = N PER WORK-ITEM" font "Computer Modern, 11" 
...
plot '../results-validation-array/TinySTM-igpu-persistent-blocks-wbetl/1/array-r99-w1-sequential-walk/tabled-heatmap-data-COALESCED-sequential' matrix rowheaders columnheaders w image,\
...
set title "STRIDED kernel memory access" font "Computer Modern,18"
plot '../results-validation-array/TinySTM-igpu-persistent-blocks-wbetl/1/array-r99-w1-sequential-walk/tabled-heatmap-data-STRIDED-sequential' matrix rowheaders columnheaders w image,\
