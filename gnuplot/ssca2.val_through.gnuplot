...
set multiplot layout 1,3 rowsfirst title "ssca2 - Reads validated/s (avg.)" font ",16"
xlabeloffsety=-2.75
set tics scale 0
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/1-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#69a2ff" lt 1 fs pattern 10, \
    ...
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-gpu/1a-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#7dafff" lt 1 fs pattern 10, \
    ...
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/2-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#94bdff" lt 1 fs pattern 10, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/4-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#9cc2ff" lt 1 fs pattern 10, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/8-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#adcdff" lt 1 fs pattern 10, \
    ...
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/16-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#b5d2ff" lt 1 fs pattern 10, \
    ...
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-gpu/32-ssca2-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#bdd7ff" lt 1 fs pattern 10, \
