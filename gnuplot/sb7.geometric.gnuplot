...
set multiplot layout 1,5 rowsfirst title "sb7 - geometric average representation of a variety of program arguments" font ",16"
set bmargin 15
xlabeloffsety=-2.75
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#69a2ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1a-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#7dafff" lt 1 fs pattern 3, \
    ...
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-2-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#94bdff" lt 1 fs pattern 3, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-4-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#9cc2ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-8-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#adcdff" lt 1 fs pattern 3, \
    ...
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-16-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#b5d2ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-32-sb7-cluster' u 2:xtic(1) t col lc rgbcolor "#bdd7ff" lt 1 fs pattern 3, \
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1a-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-2-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-4-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-8-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-16-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-32-sb7-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#69a2ff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_1 rotate by 90 left font ",8", \
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1a-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#7dafff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_1a rotate by 90 left font ",8", \
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-2-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#94bdff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_2 rotate by 90 left font ",8", \
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-4-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#9cc2ff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_4 rotate by 90 left font ",8", \
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-8-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#adcdff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_8 rotate by 90 left font ",8", \
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-16-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#b5d2ff" lt 1 fs pattern 10, \
      ''               u ($0-1):($2>0?($8/($2)):0):( sprintf('%.2g', $8/($2)) ) notitle w labels offset first leftcolumn_offset_16 rotate by 90 left font ",8", \
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-32-sb7-cluster' using ($2!=0?($8/($2)):0):xtic(1) t col lc rgbcolor "#bdd7ff" lt 1 fs pattern 10, \
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1a-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-2-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-4-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-8-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-16-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
    ...
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-32-sb7-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 3, \
...
plot\
    newhistogram "{1 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#69a2ff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_1 rotate by 90 left font ",8", \
    newhistogram "{1a threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-1a-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#7dafff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_1a rotate by 90 left font ",8", \
    newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-2-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#94bdff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_2 rotate by 90 left font ",8", \
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-4-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#9cc2ff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_4 rotate by 90 left font ",8", \
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-8-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#adcdff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_8 rotate by 90 left font ",8", \
    newhistogram "{16 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-16-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#b5d2ff" lt 1 fs pattern 6, \
      ''               u ($0-1):($14/$16):(sprintf('%2.1f', $14/$16)) notitle w labels offset first leftcolumn_offset_16 rotate by 90 left font ",8", \
    newhistogram "{32 threads}" offset char 0,xlabeloffsety, \
      'results-cpu/geometric-32-sb7-cluster' using ( $14/$16 ):xtic(1) t col lc rgbcolor "#bdd7ff" lt 1 fs pattern 6, \
