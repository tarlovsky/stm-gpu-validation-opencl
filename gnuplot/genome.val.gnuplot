...
set multiplot layout 1,3 rowsfirst title "genome - detailed commit/abort rate" font ",16"
set bmargin 12
xlabeloffsety=-2
set tics scale 0
...
plot newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results/4-genome-cluster' u 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 8, \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results/4-genome-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 8, \
      ''               u ($6) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results/8-genome-cluster' using 4:xtic(1) t col lc rgbcolor "#80b3ff" lt 1 fs pattern 8, \
      ''               u ($6) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
