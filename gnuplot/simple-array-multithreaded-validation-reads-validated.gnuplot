...
unset rmargin
unset lmargin
set multiplot layout 1,2 title "Transactional array walk application; multi-threaded validation; READS VALIDATED / VALIDATE CALL / SECOND; Intel 6700k CPU 4cores-8threads vs TinySTM-WBETL untouched" font ",14"
...
set key font ",8"
set key left
set ylabel "READS VALIDATED / FUNCTION CALL / SECOND"
