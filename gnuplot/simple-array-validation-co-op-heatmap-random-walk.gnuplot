...
splot 'results-validation-array/TinySTM-igpu-cpu-persistent-wbetl/1/array-r99-w1-random-walk/heat-file' u 2:1:3:xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TINYSTM-WBETL CPU+GPU CO-OP VALIDATION" with pm3d, \
