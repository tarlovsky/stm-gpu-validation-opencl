...
plot \
 'results-validation-array/TinySTM-igpu-persistent-wbetl/1a-array-r99-w1-random-GPU-24WKGPS-224WKGPSIZE-ACQ-REL' u 2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t col lw 2 lc rgb col_24 pt 1,\
 'results-validation-array/TinySTM-igpu-persistent-wbetl/1a-array-r99-w1-random-GPU-24WKGPS-224WKGPSIZE-ACQ-REL' u 3:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t col dt new lc rgb col_24 pt 1,\
 'results-validation-array/TinySTM-igpu-persistent-wbetl/1a-array-r99-w1-random-GPU-24WKGPS-224WKGPSIZE-ACQ-REL' u 4:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t col dt new1 lc rgb col_24 pt 1,\
 ...
 'results-validation-array/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-1THREADS-VALIDATING'      u 2:xtic(sprintf("%d/ %.2fMB",$1, ($1*8)/1000000)) t col lc rgb col_gold pt 1,\
