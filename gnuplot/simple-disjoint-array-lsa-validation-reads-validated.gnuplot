...
set bmargin 11
set lmargin 8
set multiplot layout 2,2 title "DISJOINT set READS VALIDATED/S normalized to TinySTM-untouched-Intel" font "Computer Modern,20"
col_24="#c724d6"
col_48="#44cd1"
col_gold="#8f8800"
col_red="#b01313"
...
plot \
 '< join ../results-cpu/TinySTM-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random ../results-cpu/TinySTM-wbetl-lsa/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random' u ($0):(($24/($18*1)) / ($8/($2*1))):( sprintf( '%.2fx',(($24/($18*1)) / ($8/($2*1))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl-lsa" with linespoints pt 1 lw 2 lc rgb col_gold dt new,\
 ...
 '< join ../results-cpu/TinySTM-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-wbetl-lsa/1/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/1-random' u ($0):(($28/($18*1)) / ($8/($2*1))):( sprintf( '%.2fx',(($28/($18*1)) / ($8/($2*1))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "Intel CPU-GPU co-op; GPU CAS; Blocks of 5736; sync on block; LSA" pt 2 lw 2 lc rgb "#b5d2ff" dt new with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-amd-wbetl/1/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/1-random' u ($0):(($28/($18*1)) / ($8/($2*1))):( sprintf( '%.2fx',(($28/($18*1)) / ($8/($2*1))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "AMD CPU-GPU co-op; GPU CAS; Blocks of 11264; sync on block" pt 2 lw 2 lc rgb col_red with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random ../results-cpu/TinySTM-threads-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random-4-workers' u ($0):(($24/($18*1)) / ($8/($2*1))):( sprintf( '%.2fx',(($24/($18*1)) / ($8/($2*1))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads" pt 1 lw 2 lc rgb "#696969" with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random ../results-cpu/TinySTM-threads-wbetl-lsa/1/array-strongly-scaled-r99-w1-d1-random-walk/1-random-4-workers' u ($0):(($24/($18*1)) / ($8/($2*1))):( sprintf( '%.2fx',(($24/($18*1)) / ($8/($2*1))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads LSA" pt 1 lw 2 lc rgb "#696969" dt new1 with linespoints,\

set title "2 STM threads" offset 0, -1.15 font "Computer Modern,23"
plot \
 '< join ../results-cpu/TinySTM-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random ../results-cpu/TinySTM-wbetl-lsa/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random' u ($0):(($24/($18*2)) / ($8/($2*2))):( sprintf( '%.2fx',(($24/($18*2)) / ($8/($2*2))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl-lsa" with linespoints pt 1 lw 2 lc rgb col_gold dt new,\
 ...
 '< join ../results-cpu/TinySTM-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-wbetl-lsa/2/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/2-random' u ($0):(($28/($18*2)) / ($8/($2*2))):( sprintf( '%.2fx',(($28/($18*2)) / ($8/($2*2))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "Intel CPU-GPU co-op; GPU CAS; Blocks of 5736; sync on block; LSA" pt 2 lw 2 lc rgb "#b5d2ff" dt new with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-amd-wbetl/2/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/2-random' u ($0):(($28/($18*2)) / ($8/($2*2))):( sprintf( '%.2fx',(($28/($18*2)) / ($8/($2*2))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "AMD CPU-GPU co-op; GPU CAS; Blocks of 11264; sync on block" pt 2 lw 2 lc rgb col_red with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random ../results-cpu/TinySTM-threads-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random-4-workers' u ($0):(($24/($18*2)) / ($8/($2*2))):( sprintf( '%.2fx',(($24/($18*2)) / ($8/($2*2))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads" pt 1 lw 2 lc rgb "#696969" with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random ../results-cpu/TinySTM-threads-wbetl-lsa/2/array-strongly-scaled-r99-w1-d1-random-walk/2-random-4-workers' u ($0):(($24/($18*2)) / ($8/($2*2))):( sprintf( '%.2fx',(($24/($18*2)) / ($8/($2*2))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads LSA" pt 1 lw 2 lc rgb "#696969" dt new1 with linespoints,\

set title "4 STM threads" offset 0, -1.15 font "Computer Modern,23"
plot \
 '< join ../results-cpu/TinySTM-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random ../results-cpu/TinySTM-wbetl-lsa/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random' u ($0):(($24/($18*4)) / ($8/($2*4))):( sprintf( '%.2fx',(($24/($18*4)) / ($8/($2*4))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl-lsa" with linespoints pt 1 lw 2 lc rgb col_gold dt new,\
 ...
 '< join ../results-cpu/TinySTM-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-wbetl-lsa/4/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/4-random' u ($0):(($28/($18*4)) / ($8/($2*4))):( sprintf( '%.2fx',(($28/($18*4)) / ($8/($2*4))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "Intel CPU-GPU co-op; GPU CAS; Blocks of 5736; sync on block; LSA" pt 2 lw 2 lc rgb "#b5d2ff" dt new with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-amd-wbetl/4/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/4-random' u ($0):(($28/($18*4)) / ($8/($2*4))):( sprintf( '%.2fx',(($28/($18*4)) / ($8/($2*4))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "AMD CPU-GPU co-op; GPU CAS; Blocks of 11264; sync on block" pt 2 lw 2 lc rgb col_red with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random ../results-cpu/TinySTM-threads-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random-4-workers' u ($0):(($24/($18*4)) / ($8/($2*4))):( sprintf( '%.2fx',(($24/($18*4)) / ($8/($2*4))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads" pt 1 lw 2 lc rgb "#696969" with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random ../results-cpu/TinySTM-threads-wbetl-lsa/4/array-strongly-scaled-r99-w1-d1-random-walk/4-random-4-workers' u ($0):(($24/($18*4)) / ($8/($2*4))):( sprintf( '%.2fx',(($24/($18*4)) / ($8/($2*4))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads LSA" pt 1 lw 2 lc rgb "#696969" dt new1 with linespoints,\
...
plot \
 '< join ../results-cpu/TinySTM-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random ../results-cpu/TinySTM-wbetl-lsa/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random' u ($0):(($24/($18*8)) / ($8/($2*8))):( sprintf( '%.2fx',(($24/($18*8)) / ($8/($2*8))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl-lsa" with linespoints pt 1 lw 2 lc rgb col_gold dt new,\
 ...
 '< join ../results-cpu/TinySTM-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-wbetl-lsa/8/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/8-random' u ($0):(($28/($18*8)) / ($8/($2*8))):( sprintf( '%.2fx',(($28/($18*8)) / ($8/($2*8))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "Intel CPU-GPU co-op; GPU CAS; Blocks of 5736; sync on block; LSA" pt 2 lw 2 lc rgb "#b5d2ff" dt new with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random ../results-cpu/TinySTM-igpu-cpu-persistent-dynamic-split-multithreaded-amd-wbetl/8/array-strongly-scaled-shared-gpu-r99-w1-d1-random-walk/8-random' u ($0):(($28/($18*8)) / ($8/($2*8))):( sprintf( '%.2fx',(($28/($18*8)) / ($8/($2*8))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "AMD CPU-GPU co-op; GPU CAS; Blocks of 11264; sync on block" pt 2 lw 2 lc rgb col_red with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random ../results-cpu/TinySTM-threads-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random-4-workers' u ($0):(($24/($18*8)) / ($8/($2*8))):( sprintf( '%.2fx',(($24/($18*8)) / ($8/($2*8))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads" pt 1 lw 2 lc rgb "#696969" with linespoints,\
 '< join ../results-cpu/TinySTM-wbetl/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random ../results-cpu/TinySTM-threads-wbetl-lsa/8/array-strongly-scaled-r99-w1-d1-random-walk/8-random-4-workers' u ($0):(($24/($18*8)) / ($8/($2*8))):( sprintf( '%.2fx',(($24/($18*8)) / ($8/($2*8))) ) ):xtic(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t "TinySTM-wbetl 4 validation worker threads LSA" pt 1 lw 2 lc rgb "#696969" dt new1 with linespoints,\
