...
'' u 18:xticlabels(sprintf("%'d (%.2fMB)",$1, ($1*8)/1000000)) t col lc rgbcolor "#d1d1cd" fs pattern 10, \
      '<tail -n+2 ../results-validation-array/TinySTM-igpu-cpu-persistent-dynamic-split-wbetl-block-level-sync-k-1/1/array-r99-w1-random-walk/1-random-cpu-validation' u ($0-0.104):(($14!=0)?($14+$14*0.20):NaN):(sprintf("%'d", $14)) notitle w labels rotate by 90 left textcolor rgb "#000000" font "Computer Modern,13.5", \
