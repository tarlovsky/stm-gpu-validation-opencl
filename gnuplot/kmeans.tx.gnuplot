...
set multiplot layout 2,3 rowsfirst title "kmeans - detailed validation success/failure" font ",16"
set bmargin 12
xlabeloffsety=-2
set tics scale 0
...
set title "kmeans-high" font ",12" tc rgb "#606060"
plot newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results/2-kmeans-high-cluster' u 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ...
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first 0 rotate by 90 right font ",6", \
    ...
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results/4-kmeans-high-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ''               u ($10) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 3, \
      ...
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first leftcolumn_offset_4 rotate by 90 right font ",6", \
    ...
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results/8-kmeans-high-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ''               u ($10) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 3, \
      ...
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first leftcolumn_offset_8 rotate by 90 right font ",6", \
...
set title "kmeans-low" font ",12" tc rgb "#606060"
plot newhistogram "{2 threads}" offset char 0,xlabeloffsety, \
      'results/2-kmeans-low-cluster' u 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ''               u ($10) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 3, \
      ''               u ($0-1-0.27):($12):(sprintf('%d', $12)) notitle w labels rotate by 90 left font ",8", \
      ''               u ($0-1+0.27):($12+$10):(sprintf('%d', $10)) notitle w labels rotate by 90 left font ",8", \
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first 0 rotate by 90 right font ",6", \
      ...
      ''               u ($0-1):($12+$10):11 w yerr ls 1 lc rgb 'black' t "", \
    newhistogram "{4 threads}" offset char 0,xlabeloffsety, \
      'results/4-kmeans-low-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ''               u ($10) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 3, \
      ''               u ($0-1-0.27):($12):(sprintf('%d', $12)) notitle w labels offset first leftcolumn_offset_4 rotate by 90 left font ",8", \
      ''               u ($0-1+0.27):($12+$10):(sprintf('%d', $10)) notitle w labels offset first leftcolumn_offset_4 rotate by 90 left font ",8", \
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first leftcolumn_offset_4 rotate by 90 right font ",6", \
      ...
      ''               u ($0-1+leftcolumn_offset_4):($12+$10):11 w yerr ls 1 lc rgb 'black' t "", \
    newhistogram "{8 threads}" offset char 0,xlabeloffsety, \
      'results/8-kmeans-low-cluster' using 12:xtic(1) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 6, \
      ''               u ($10) t col lc rgbcolor "#b3d1ff" lt 1 fs pattern 3, \
      ''               u ($0-1-0.27):($12):(sprintf('%d', $12)) notitle w labels offset first leftcolumn_offset_8 rotate by 90 left font ",8", \
      ''               u ($0-1+0.27):($12+$10):(sprintf('%d', $10)) notitle w labels offset first leftcolumn_offset_8 rotate by 90 left font ",8", \
      ''               u ($0-1):($8-$8):(sprintf('%2.1f%', $12/($10)*100)) notitle w labels offset first leftcolumn_offset_8 rotate by 90 right font ",6", \
