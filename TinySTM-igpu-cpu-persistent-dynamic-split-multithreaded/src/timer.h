...
static struct timespec timespec_max(const struct timespec t1, const struct timespec t2){
...
static struct timespec timespec_min(const struct timespec t1, const struct timespec t2){
...
#define TIMER_MAX(t1, t2)               timespec_max(t1, t2)

#define TIMER_MIN(t1, t2)               timespec_min(t1, t2)
#endif /* TIMER_H */
/* =============================================================================
 *
 * End of timer.h
