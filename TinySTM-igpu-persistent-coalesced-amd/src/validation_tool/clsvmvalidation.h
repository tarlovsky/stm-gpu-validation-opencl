...
#define BIN_KERNEL_INSTANT "/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent-coalesced-amd/src/validation_tool/instant_kernel.bin"
#define CL_KERNEL_INSTANT "/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent-coalesced-amd/src/validation_tool/instant_kernel.cl"
#define CL_KERNEL_INSTANT_DEBUG "instant_kernel_debug.cl"
#define CL_KERNEL_INSTANT_NAME "InstantKernel"

#define BIN_KERNEL_REGULAR "/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent-coalesced-amd/src/validation_tool/regular_kernel.bin"
#define CL_KERNEL_REGULAR "/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent-coalesced-amd/src/validation_tool/regular_kernel.cl"
#define CL_KERNEL_REGULAR_NAME "RegularKernel"

/* vtune */
//#define CL_KERNEL_PROGRAM_OPTIONS "-I/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent--coalesced/src/validation_tool -g -s " CL_KERNEL_INSTANT " -cl-std=CL2.0" //added I flag to share debug_validation header and define.
/* normal exec */
#define CL_KERNEL_PROGRAM_OPTIONS "-I/home/otarlovskyy/stm-validation-study-63/TinySTM-igpu-persistent-coalesced-amd/src/validation_tool -cl-std=CL2.0" //added I flag to share debug_validation header and define.
