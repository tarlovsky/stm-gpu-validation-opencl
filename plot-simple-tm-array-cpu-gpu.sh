...
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-16THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"CPU 02 16 THREADS VALIDATING random array traversal\" dt new lc rgb \"black\" pt 7,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-8THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"CPU 02 8 THREADS VALIDATING random array traversal\" lc rgb \"black\" pt 7,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-4THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"CPU 02 4 THREADS VALIDATING random array traversal\" dt new1 lc rgb \"black\" pt 7,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-1THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"CPU 02 1 THREADS VALIDATING random array traversal\" lc rgb col_gold pt 17,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-sequential-CPU-O2-1THREADS-VALIDATING'u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"CPU 02 1 THREADS VALIDATING sequential array traversal\" dt new lc rgb col_gold pt 17,\\"  >> $FILE
...
echo  "plot \\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-16THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"random walk CPU 02 16 THREADS VALIDATING\" dt new lc rgb \"black\" pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-8THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"random walk CPU 02   8 THREADS VALIDATING\" lc rgb \"black\" pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-4THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"random walk CPU 02   4 THREADS VALIDATING\" dt new1 lc rgb \"black\" pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-random-CPU-O2-1THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"random walk CPU 02   1 THREADS VALIDATING\" lw 2 lc rgb \"black\" pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-sequential-CPU-O2-16THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"sequential walk CPU O2 16 THREADS VALIDATING\" dt new lc rgb col_gold pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-sequential-CPU-O2-8THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"sequential walk CPU O2   8 THREADS VALIDATING\" lc rgb col_gold pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-sequential-CPU-O2-4THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"sequential walk CPU O2   4 THREADS VALIDATING\" dt new1 lc rgb col_gold pt 1,\\"  >> $FILE
echo  " '$RESULTS_DIR/TinySTM-wbetl/1a-array-r99-w1-sequential-CPU-O2-1THREADS-VALIDATING' u 2:xtic(sprintf(\"%d/ %.2fMB\",\$1, (\$1*8)/1000000)) t \"sequential walk CPU O2   1 THREADS VALIDATING\" lw 2 dt new lc rgb col_gold pt 1"  >> $FILE
